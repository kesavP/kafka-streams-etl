...
public class OrderValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -650047727707948391L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderValue\",\"namespace\":\"com.tribune.demo.ecommerce.domain.avro.order\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"double\"}]}");
   ...
   */
  public OrderValue(java.lang.Long id, java.lang.CharSequence title, java.lang.Double price) {
    this.id = id;
    this.title = title;
    this.price = price;
  }
   ...
   */
  public static com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder newBuilder() {
    return new com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder();
  }
   ...
   * @return A new OrderValue RecordBuilder
   */
  public static com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder newBuilder(com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder other) {
    if (other == null) {
      return new com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder();
    } else {
      return new com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder(other);
    }
  }
   ...
   * @return A new OrderValue RecordBuilder
   */
  public static com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder newBuilder(com.tribune.demo.ecommerce.domain.avro.order.OrderValue other) {
    if (other == null) {
      return new com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder();
    } else {
      return new com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderValue>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.tribune.demo.ecommerce.domain.avro.order.OrderValue other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tribune.demo.ecommerce.domain.avro.order.OrderValue.Builder clearPrice() {
  ...
  public boolean equals(Object o) {
    ...
    OrderValue other = (OrderValue) o;
    if (this.id != other.id) {
      return false;
    }
    if (Utf8.compareSequences(this.title, other.title) != 0) {
      return false;
    }
